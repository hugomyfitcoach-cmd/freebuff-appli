...
| | |
| --- | --- |
| Slug | `swiss-ball-crunch` |
| Nom (FR / EN) | Crunch sur Swiss Ball / Swiss Ball Crunch |
| Catégorie | Tronc |
| Groupe musculaire principal | Abdominaux |
| Muscles primaires | Abdominaux |
| Muscles secondaires | Obliques, Quadriceps |
| Matériel | Swiss Ball |
...
| Fichier | Rôle |
| --- | --- |
| `animation.mp4` (153 Ko) | **Média canonique** — boucle **départ → fin → départ** (720×720, 2,8 s), affiché partout dans l'application. |

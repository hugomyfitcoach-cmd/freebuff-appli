# Rollout à genoux sur Swiss Ball
...
| | |
| --- | --- |
| Slug | `swiss-ball-kneeling-rollout` |
| Nom (FR / EN) | Rollout à genoux sur Swiss Ball / Swiss Ball Kneeling Rollout |
| Catégorie | Tronc |
| Groupe musculaire principal | Abdominaux |
| Muscles primaires | Abdominaux |
| Muscles secondaires | Grand dorsal, Épaules, Érecteurs du rachis |
| Matériel | Swiss Ball |
...
| Fichier | Rôle |
| --- | --- |
| `animation.mp4` (159 Ko) | **Média canonique** — boucle **départ → fin → départ** (720×720, 2,8 s), affiché partout dans l'application. |
| `poster.webp` (22 Ko) | Vignette statique (position de fin, asset legacy optionnel). |

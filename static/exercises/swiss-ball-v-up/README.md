...
| | |
| --- | --- |
| Slug | `swiss-ball-v-up` |
| Nom (FR / EN) | V-Up avec Swiss Ball / Swiss Ball V-Up |
| Catégorie | Tronc |
...
| Fichier | Rôle |
| --- | --- |
| `animation.mp4` (126 Ko) | **Média canonique** — boucle **départ → fin → départ** (720×720, 2,8 s), affiché partout dans l'application. |

...
| | |
| --- | --- |
| Slug | `swiss-ball-stir-the-pot` |
| Nom (FR / EN) | Stir the Pot sur Swiss Ball / Swiss Ball Stir the Pot |
| Catégorie | Tronc |
...
| Fichier | Rôle |
| --- | --- |
| `animation.mp4` (120 Ko) | **Média canonique** — boucle **départ → fin → départ** (720×720, 2,8 s), affiché partout dans l'application. |
| `poster.webp` (18 Ko) | Vignette statique (position de fin, asset legacy optionnel). |

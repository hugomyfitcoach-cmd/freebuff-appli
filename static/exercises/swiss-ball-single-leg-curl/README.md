# Leg curl unilatéral sur Swiss Ball
...
| | |
| --- | --- |
| Slug | `swiss-ball-single-leg-curl` |
| Nom (FR / EN) | Leg curl unilatéral sur Swiss Ball / Swiss Ball Single Leg Curl |
| Catégorie | Bas du corps |
| Groupe musculaire principal | Ischio-jambiers |
| Muscles primaires | Ischio-jambiers |
| Muscles secondaires | Grand fessier, Mollets, Abdominaux |
| Matériel | Swiss Ball |

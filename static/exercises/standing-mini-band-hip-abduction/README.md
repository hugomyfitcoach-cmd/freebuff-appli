# Abduction de hanche debout avec mini-bande
...
| | |
| --- | --- |
| Slug | `standing-mini-band-hip-abduction` |
| Nom (FR / EN) | Abduction de hanche debout avec mini-bande / Standing Hip Abduction with Mini Band |
...
- [x] Anti-doublon : aucune abduction debout avec bande dans la Exercise DB
      (les abductions existantes = machine/poids du corps, matériels différents).

...
| | |
| --- | --- |
| Slug | `swiss-ball-body-saw` |
| Nom (FR / EN) | Body saw sur Swiss Ball / Swiss Ball Body Saw |
| Catégorie | Tronc |
| Groupe musculaire principal | Abdominaux |
| Muscles primaires | Abdominaux |
| Muscles secondaires | Obliques, Épaules, Quadriceps |
| Matériel | Swiss Ball |
...
| Fichier | Rôle |
| --- | --- |
| `animation.mp4` (133 Ko) | **Média canonique** — boucle **départ → fin → départ** (720×720, 2,8 s), affiché partout dans l'application. |

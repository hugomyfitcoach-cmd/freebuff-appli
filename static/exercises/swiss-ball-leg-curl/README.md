...
| Nom (FR / EN) | Leg curl sur Swiss Ball / Swiss Ball Leg Curl |
...
| Fichier | Rôle |
| --- | --- |
| `animation.mp4` (131 Ko) | **Média canonique** — boucle **départ → fin → départ** (720×720, 2,8 s), affiché partout dans l'application. |

...
| | |
| --- | --- |
| Slug | `swiss-ball-side-plank` |
| Nom (FR / EN) | Side plank sur Swiss Ball / Swiss Ball Side Plank |
| Catégorie | Tronc |
| Groupe musculaire principal | Obliques |
| Muscles primaires | Obliques |
| Muscles secondaires | Abdominaux, Moyen fessier, Épaules |
| Matériel | Swiss Ball |
...
| Fichier | Rôle |
| --- | --- |
| `animation.mp4` (142 Ko) | **Média canonique** — boucle **départ → fin → départ** (720×720, 2,8 s), affiché partout dans l'application. |

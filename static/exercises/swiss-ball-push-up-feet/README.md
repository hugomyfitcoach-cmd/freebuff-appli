...
| | |
| --- | --- |
| Slug | `swiss-ball-push-up-feet` |
| Nom (FR / EN) | Pompes pieds sur Swiss Ball / Swiss Ball Push-up (Feet on Ball) |
...
| Fichier | Rôle |
| --- | --- |
| `animation.mp4` (149 Ko) | **Média canonique** — boucle **départ → fin → départ** (720×720, 2,8 s), affiché partout dans l'application. |

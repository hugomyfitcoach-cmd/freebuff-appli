...
| | |
| --- | --- |
| Slug | `swiss-ball-back-extension` |
| Nom (FR / EN) | Extension lombaire sur Swiss Ball / Swiss Ball Back Extension |
| Catégorie | Tronc |
| Groupe musculaire principal | Érecteurs du rachis |
| Muscles primaires | Érecteurs du rachis |
| Muscles secondaires | Grand fessier, Ischio-jambiers, Grand dorsal |
| Matériel | Swiss Ball |
...
| Fichier | Rôle |
| --- | --- |
| `animation.mp4` (146 Ko) | **Média canonique** — boucle **départ → fin → départ** (720×720, 2,8 s), affiché partout dans l'application. |
| `poster.webp` (21 Ko) | Vignette statique (position de fin, asset legacy optionnel). |

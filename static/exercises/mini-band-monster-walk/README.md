...
| Nom (FR / EN) | Monster Walk avec mini-bande / Mini Band Monster Walk |
| Catégorie | Bas du corps |
| Groupe musculaire principal | Fessiers |
| Muscles primaires | Moyen fessier |
| Muscles secondaires | Grand fessier, Quadriceps |
| Matériel | Mini-bande |
...
- [x] Anti-doublon : `monster walk` (exercisedb-v1, poids du corps, GIF homme)
      = même mouvement avec le même outil — entrée officielle G-FLUX créée,
      doublon importé masqué réversiblement à la synchro.

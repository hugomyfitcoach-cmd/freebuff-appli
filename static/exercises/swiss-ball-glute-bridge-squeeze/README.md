# Pont fessier avec Swiss Ball et squeeze des adducteurs
...
| | |
| --- | --- |
| Slug | `swiss-ball-glute-bridge-squeeze` |
| Nom (FR / EN) | Pont fessier avec Swiss Ball et squeeze des adducteurs / Swiss Ball Glute Bridge with Adductor Squeeze |
| Catégorie | Bas du corps |
| Groupe musculaire principal | Fessiers |
| Muscles primaires | Grand fessier, Adducteurs |
...
| Fichier | Rôle |
| --- | --- |
| `animation.mp4` (138 Ko) | **Média canonique** — boucle **départ → fin → départ** (720×720, 2,8 s), affiché partout dans l'application. |
| `poster.webp` (19 Ko) | Vignette statique (position de fin, asset legacy optionnel). |

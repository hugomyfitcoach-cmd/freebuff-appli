...
| | |
| --- | --- |
| Slug | `swiss-ball-pike` |
| Nom (FR / EN) | Pike sur Swiss Ball / Swiss Ball Pike |
| Catégorie | Tronc |
| Groupe musculaire principal | Abdominaux |
| Muscles primaires | Abdominaux |
| Muscles secondaires | Épaules, Grand dorsal, Quadriceps |
| Matériel | Swiss Ball |
...
| Fichier | Rôle |
| --- | --- |
| `animation.mp4` (158 Ko) | **Média canonique** — boucle **départ → fin → départ** (720×720, 2,8 s), affiché partout dans l'application. |

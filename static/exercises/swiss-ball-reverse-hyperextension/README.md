# Extension de hanche inversée sur Swiss Ball
...
| | |
| --- | --- |
| Slug | `swiss-ball-reverse-hyperextension` |
| Nom (FR / EN) | Extension de hanche inversée sur Swiss Ball / Swiss Ball Reverse Hyperextension |
| Catégorie | Bas du corps |
| Groupe musculaire principal | Fessiers |
| Muscles primaires | Grand fessier |
| Muscles secondaires | Ischio-jambiers, Érecteurs du rachis, Abdominaux |
| Matériel | Swiss Ball |
...
| Fichier | Rôle |
| --- | --- |
| `animation.mp4` (148 Ko) | **Média canonique** — boucle **départ → fin → départ** (720×720, 2,8 s), affiché partout dans l'application. |

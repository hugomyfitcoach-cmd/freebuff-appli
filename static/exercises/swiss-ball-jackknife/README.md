...
| | |
| --- | --- |
| Slug | `swiss-ball-jackknife` |
| Nom (FR / EN) | Jackknife sur Swiss Ball / Swiss Ball Jackknife |
| Catégorie | Tronc |
...
| Fichier | Rôle |
| --- | --- |
| `animation.mp4` (152 Ko) | **Média canonique** — boucle **départ → fin → départ** (720×720, 2,8 s), affiché partout dans l'application. |
| `poster.webp` (23 Ko) | Vignette statique (position de fin, asset legacy optionnel). |

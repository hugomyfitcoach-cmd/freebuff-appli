...
| | |
| --- | --- |
| Slug | `swiss-ball-wall-squat` |
| Nom (FR / EN) | Squat mural avec Swiss Ball / Swiss Ball Wall Squat |
| Catégorie | Bas du corps |
| Groupe musculaire principal | Quadriceps |
| Muscles primaires | Quadriceps |
| Muscles secondaires | Grand fessier, Ischio-jambiers, Mollets |
| Matériel | Swiss Ball |
...
| Fichier | Rôle |
| --- | --- |
| `animation.mp4` (143 Ko) | **Média canonique** — boucle **départ → fin → départ** (720×720, 2,8 s), affiché partout dans l'application. |
| `poster.webp` (20 Ko) | Vignette statique (position de fin, asset legacy optionnel). |

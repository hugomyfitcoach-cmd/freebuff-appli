...
| | |
| --- | --- |
| Slug | `swiss-ball-hip-thrust` |
| Nom (FR / EN) | Hip thrust sur Swiss Ball / Swiss Ball Hip Thrust |
...
| Fichier | Rôle |
| --- | --- |
| `animation.mp4` (130 Ko) | **Média canonique** — boucle **départ → fin → départ** (720×720, 2,8 s), affiché partout dans l'application. |
